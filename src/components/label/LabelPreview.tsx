...
export const LabelPreview = ({ 
  ...
  return (
    <div className="label-preview bg-white border-2 border-black border-dotted rounded-lg p-4 flex flex-col items-center justify-between space-y-2 my-4 pt-6">
